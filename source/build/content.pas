...
begin
  ...
  AddFunction(@TIntegerArray_Descend, 'function TIntegerArray_Descend(const arr: TIntegerArray): Boolean;');
  AddFunction(@TIntegerArray_Ascend, 'function TIntegerArray_Ascend(const arr: TIntegerArray): Boolean;');
  ...
  AddFunction(@TIntegerArray_Undupe, 'function TIntegerArray_Undupe(var arr: TIntegerArray): Integer;');
  ...
  AddFunction(@TPointArray_Undupe, 'function TPointArray_Undupe(var arr: TPointArray): Integer;');
  ...
  AddFunction(@TArray_Append1, 'function TArray_Append(var arr: TIntegerArray; const item: Integer; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append2, 'function TArray_Append(var arr: TDoubleArray; const item: Double; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append3, 'function TArray_Append(var arr: TStringArray; const item: string; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append4, 'function TArray_Append(var arr: TCharArray; const item: Char; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append5, 'function TArray_Append(var arr: TBooleanArray; const item: Boolean; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append6, 'function TArray_Append(var arr: TPointArray; const item: TPoint; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append7, 'function TArray_Append(var arr: TBoxArray; const item: TBox; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append8, 'function TArray_Append(var arr: TRangeArray; const item: TRange; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append9, 'function TArray_Append(var arr: TIntegerArray; const items: TIntegerArray; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append10, 'function TArray_Append(var arr: TDoubleArray; const items: TDoubleArray; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append11, 'function TArray_Append(var arr: TStringArray; const items: TStringArray; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append12, 'function TArray_Append(var arr: TCharArray; const items: TCharArray; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append13, 'function TArray_Append(var arr: TBooleanArray; const items: TBooleanArray; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append14, 'function TArray_Append(var arr: TPointArray; const items: TPointArray; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append15, 'function TArray_Append(var arr: TBoxArray; const items: TBoxArray; const duplicates: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Append16, 'function TArray_Append(var arr: TRangeArray; const items: TRangeArray; const duplicates: Boolean = True): Integer; overload;');
  ...
  AddFunction(@TArray_BuiltWith1, 'function TArray_BuiltWith(const arr, allowed: TIntegerArray): Boolean; overload;');
  AddFunction(@TArray_BuiltWith2, 'function TArray_BuiltWith(const arr, allowed: TDoubleArray): Boolean; overload;');
  AddFunction(@TArray_BuiltWith3, 'function TArray_BuiltWith(const arr, allowed: TStringArray): Boolean; overload;');
  AddFunction(@TArray_BuiltWith4, 'function TArray_BuiltWith(const arr, allowed: TCharArray): Boolean; overload;');
  AddFunction(@TArray_BuiltWith5, 'function TArray_BuiltWith(const arr, allowed: TBooleanArray): Boolean; overload;');
  AddFunction(@TArray_BuiltWith6, 'function TArray_BuiltWith(const arr, allowed: TPointArray): Boolean; overload;');
  AddFunction(@TArray_BuiltWith7, 'function TArray_BuiltWith(const arr, allowed: TBoxArray): Boolean; overload;');
  AddFunction(@TArray_BuiltWith8, 'function TArray_BuiltWith(const arr, allowed: TRangeArray): Boolean; overload;');
  ...
  AddFunction(@TArray_Deduplicate1, 'function TArray_Deduplicate(var arr: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Deduplicate2, 'function TArray_Deduplicate(var arr: TDoubleArray): Integer; overload;');
  AddFunction(@TArray_Deduplicate3, 'function TArray_Deduplicate(var arr: TStringArray): Integer; overload;');
  AddFunction(@TArray_Deduplicate4, 'function TArray_Deduplicate(var arr: TCharArray): Integer; overload;');
  AddFunction(@TArray_Deduplicate5, 'function TArray_Deduplicate(var arr: TBooleanArray): Integer; overload;');
  AddFunction(@TArray_Deduplicate6, 'function TArray_Deduplicate(var arr: TPointArray): Integer; overload;');
  AddFunction(@TArray_Deduplicate7, 'function TArray_Deduplicate(var arr: TBoxArray): Integer; overload;');
  AddFunction(@TArray_Deduplicate8, 'function TArray_Deduplicate(var arr: TRangeArray): Integer; overload;');

  AddFunction(@TArray_Delete1, 'function TArray_Delete(var arr: TIntegerArray; const index: Integer = 0): Boolean; overload;');
  AddFunction(@TArray_Delete2, 'function TArray_Delete(var arr: TDoubleArray; const index: Integer = 0): Boolean; overload;');
  AddFunction(@TArray_Delete3, 'function TArray_Delete(var arr: TStringArray; const index: Integer = 0): Boolean; overload;');
  AddFunction(@TArray_Delete4, 'function TArray_Delete(var arr: TCharArray; const index: Integer = 0): Boolean; overload;');
  AddFunction(@TArray_Delete5, 'function TArray_Delete(var arr: TBooleanArray; const index: Integer = 0): Boolean; overload;');
  AddFunction(@TArray_Delete6, 'function TArray_Delete(var arr: TPointArray; const index: Integer = 0): Boolean; overload;');
  AddFunction(@TArray_Delete7, 'function TArray_Delete(var arr: TBoxArray; const index: Integer = 0): Boolean; overload;');
  AddFunction(@TArray_Delete8, 'function TArray_Delete(var arr: TRangeArray; const index: Integer = 0): Boolean; overload;');
  AddFunction(@TArray_Delete9, 'function TArray_Delete(var arr: TIntegerArray; const ID: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Delete10, 'function TArray_Delete(var arr: TDoubleArray; const ID: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Delete11, 'function TArray_Delete(var arr: TStringArray; const ID: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Delete12, 'function TArray_Delete(var arr: TCharArray; const ID: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Delete13, 'function TArray_Delete(var arr: TBooleanArray; const ID: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Delete14, 'function TArray_Delete(var arr: TPointArray; const ID: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Delete15, 'function TArray_Delete(var arr: TBoxArray; const ID: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Delete16, 'function TArray_Delete(var arr: TRangeArray; const ID: TIntegerArray): Integer; overload;');
  ...
  AddFunction(@TArray_Dump1, 'function TArray_Dump(var arr: TIntegerArray; const items: TIntegerArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Dump2, 'function TArray_Dump(var arr: TDoubleArray; const items: TDoubleArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Dump3, 'function TArray_Dump(var arr: TStringArray; const items: TStringArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Dump4, 'function TArray_Dump(var arr: TCharArray; const items: TCharArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Dump5, 'function TArray_Dump(var arr: TBooleanArray; const items: TBooleanArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Dump6, 'function TArray_Dump(var arr: TPointArray; const items: TPointArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Dump7, 'function TArray_Dump(var arr: TBoxArray; const items: TBoxArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Dump8, 'function TArray_Dump(var arr: TRangeArray; const items: TRangeArray; const index: Integer = 0): Integer; overload;');
  ...
  AddFunction(@TArray_Erase1, 'function TArray_Erase(var arr: TIntegerArray; const item: Integer; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase2, 'function TArray_Erase(var arr: TDoubleArray; const item: Double; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase3, 'function TArray_Erase(var arr: TStringArray; const item: string; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase4, 'function TArray_Erase(var arr: TCharArray; const item: Char; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase5, 'function TArray_Erase(var arr: TBooleanArray; const item: Boolean; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase6, 'function TArray_Erase(var arr: TPointArray; const item: TPoint; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase7, 'function TArray_Erase(var arr: TBoxArray; const item: TBox; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase8, 'function TArray_Erase(var arr: TRangeArray; const item: TRange; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase9, 'function TArray_Erase(var arr: TIntegerArray; const item: Integer; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase10, 'function TArray_Erase(var arr: TDoubleArray; const item: Double; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase11, 'function TArray_Erase(var arr: TStringArray; const item: string; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase12, 'function TArray_Erase(var arr: TCharArray; const item: Char; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase13, 'function TArray_Erase(var arr: TBooleanArray; const item: Boolean; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase14, 'function TArray_Erase(var arr: TPointArray; const item: TPoint; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase15, 'function TArray_Erase(var arr: TBoxArray; const item: TBox; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase16, 'function TArray_Erase(var arr: TRangeArray; const item: TRange; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase17, 'function TArray_Erase(var arr: TIntegerArray; const items: TIntegerArray; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase18, 'function TArray_Erase(var arr: TDoubleArray; const items: TDoubleArray; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase19, 'function TArray_Erase(var arr: TStringArray; const items: TStringArray; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase20, 'function TArray_Erase(var arr: TCharArray; const items: TCharArray; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase21, 'function TArray_Erase(var arr: TBooleanArray; const items: TBooleanArray; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase22, 'function TArray_Erase(var arr: TPointArray; const items: TPointArray; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase23, 'function TArray_Erase(var arr: TBoxArray; const items: TBoxArray; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase24, 'function TArray_Erase(var arr: TRangeArray; const items: TRangeArray; const index: Integer = 2147483647; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Erase25, 'function TArray_Erase(var arr: TIntegerArray; const items: TIntegerArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase26, 'function TArray_Erase(var arr: TDoubleArray; const items: TDoubleArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase27, 'function TArray_Erase(var arr: TStringArray; const items: TStringArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase28, 'function TArray_Erase(var arr: TCharArray; const items: TCharArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase29, 'function TArray_Erase(var arr: TBooleanArray; const items: TBooleanArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase30, 'function TArray_Erase(var arr: TPointArray; const items: TPointArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase31, 'function TArray_Erase(var arr: TBoxArray; const items: TBoxArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Erase32, 'function TArray_Erase(var arr: TRangeArray; const items: TRangeArray; const all: Boolean): Integer; overload;');
  ...
  AddFunction(@TArray_IDs1, 'function TArray_IDs(const arr: TIntegerArray; const ascending: Boolean = True): TIntegerArray; overload;');
  AddFunction(@TArray_IDs2, 'function TArray_IDs(const arr: TDoubleArray; const ascending: Boolean = True): TIntegerArray; overload;');
  AddFunction(@TArray_IDs3, 'function TArray_IDs(const arr: TStringArray; const ascending: Boolean = True): TIntegerArray; overload;');
  AddFunction(@TArray_IDs4, 'function TArray_IDs(const arr: TCharArray; const ascending: Boolean = True): TIntegerArray; overload;');
  AddFunction(@TArray_IDs5, 'function TArray_IDs(const arr: TBooleanArray; const ascending: Boolean = True): TIntegerArray; overload;');
  AddFunction(@TArray_IDs6, 'function TArray_IDs(const arr: TPointArray; const ascending: Boolean = True): TIntegerArray; overload;');
  AddFunction(@TArray_IDs7, 'function TArray_IDs(const arr: TBoxArray; const ascending: Boolean = True): TIntegerArray; overload;');
  AddFunction(@TArray_IDs8, 'function TArray_IDs(const arr: TRangeArray; const ascending: Boolean = True): TIntegerArray; overload;');
  ...
  AddFunction(@TArray_Keep1, 'function TArray_Keep(var arr: TIntegerArray; const items: TIntegerArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Keep2, 'function TArray_Keep(var arr: TDoubleArray; const items: TDoubleArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Keep3, 'function TArray_Keep(var arr: TStringArray; const items: TStringArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Keep4, 'function TArray_Keep(var arr: TCharArray; const items: TCharArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Keep5, 'function TArray_Keep(var arr: TBooleanArray; const items: TBooleanArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Keep6, 'function TArray_Keep(var arr: TPointArray; const items: TPointArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Keep7, 'function TArray_Keep(var arr: TBoxArray; const items: TBoxArray; const index: Integer = 0): Integer; overload;');
  AddFunction(@TArray_Keep8, 'function TArray_Keep(var arr: TRangeArray; const items: TRangeArray; const index: Integer = 0): Integer; overload;');
  ...
  AddFunction(@TArray_Len9, 'function TArray_Len(var arr: TIntegerArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Len10, 'function TArray_Len(var arr: TDoubleArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Len11, 'function TArray_Len(var arr: TStringArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Len12, 'function TArray_Len(var arr: TCharArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Len13, 'function TArray_Len(var arr: TBooleanArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Len14, 'function TArray_Len(var arr: TPointArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Len15, 'function TArray_Len(var arr: TBoxArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Len16, 'function TArray_Len(var arr: TRangeArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Len17, 'function TArray_Len(var arr: TIntegerArray; const aSize: Integer; const null: Integer): Integer; overload;');
  AddFunction(@TArray_Len18, 'function TArray_Len(var arr: TDoubleArray; const aSize: Integer; const null: Double): Integer; overload;');
  AddFunction(@TArray_Len19, 'function TArray_Len(var arr: TStringArray; const aSize: Integer; const null: string): Integer; overload;');
  AddFunction(@TArray_Len20, 'function TArray_Len(var arr: TCharArray; const aSize: Integer; const null: Char): Integer; overload;');
  AddFunction(@TArray_Len21, 'function TArray_Len(var arr: TBooleanArray; const aSize: Integer; const null: Boolean): Integer; overload;');
  AddFunction(@TArray_Len22, 'function TArray_Len(var arr: TPointArray; const aSize: Integer; const null: TPoint): Integer; overload;');
  ...
  AddFunction(@TArray_Move1, 'function TArray_Move(var arr: TIntegerArray; oldIndex, newIndex: Integer): Boolean; overload;');
  AddFunction(@TArray_Move2, 'function TArray_Move(var arr: TDoubleArray; oldIndex, newIndex: Integer): Boolean; overload;');
  AddFunction(@TArray_Move3, 'function TArray_Move(var arr: TStringArray; oldIndex, newIndex: Integer): Boolean; overload;');
  AddFunction(@TArray_Move4, 'function TArray_Move(var arr: TCharArray; oldIndex, newIndex: Integer): Boolean; overload;');
  AddFunction(@TArray_Move5, 'function TArray_Move(var arr: TBooleanArray; oldIndex, newIndex: Integer): Boolean; overload;');
  ...
  AddFunction(@TArray_Push1, 'function TArray_Push(var arr: TIntegerArray; const item: Integer): Integer; overload;');
  AddFunction(@TArray_Push2, 'function TArray_Push(var arr: TDoubleArray; const item: Double): Integer; overload;');
  AddFunction(@TArray_Push3, 'function TArray_Push(var arr: TStringArray; const item: string): Integer; overload;');
  AddFunction(@TArray_Push4, 'function TArray_Push(var arr: TCharArray; const item: Char): Integer; overload;');
  AddFunction(@TArray_Push5, 'function TArray_Push(var arr: TBooleanArray; const item: Boolean): Integer; overload;');
  AddFunction(@TArray_Push6, 'function TArray_Push(var arr: TPointArray; const item: TPoint): Integer; overload;');
  AddFunction(@TArray_Push7, 'function TArray_Push(var arr: TBoxArray; const item: TBox): Integer; overload;');
  AddFunction(@TArray_Push8, 'function TArray_Push(var arr: TRangeArray; const item: TRange): Integer; overload;');
  AddFunction(@TArray_Push9, 'function TArray_Push(var arr: TIntegerArray; const items: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Push10, 'function TArray_Push(var arr: TDoubleArray; const items: TDoubleArray): Integer; overload;');
  AddFunction(@TArray_Push11, 'function TArray_Push(var arr: TStringArray; const items: TStringArray): Integer; overload;');
  AddFunction(@TArray_Push12, 'function TArray_Push(var arr: TCharArray; const items: TCharArray): Integer; overload;');
  AddFunction(@TArray_Push13, 'function TArray_Push(var arr: TBooleanArray; const items: TBooleanArray): Integer; overload;');
  AddFunction(@TArray_Push14, 'function TArray_Push(var arr: TPointArray; const items: TPointArray): Integer; overload;');
  AddFunction(@TArray_Push15, 'function TArray_Push(var arr: TBoxArray; const items: TBoxArray): Integer; overload;');
  AddFunction(@TArray_Push16, 'function TArray_Push(var arr: TRangeArray; const items: TRangeArray): Integer; overload;');

  AddFunction(@TArray_Remove1, 'function TArray_Remove(var arr: TIntegerArray; const item: Integer; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove2, 'function TArray_Remove(var arr: TDoubleArray; const item: Double; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove3, 'function TArray_Remove(var arr: TStringArray; const item: string; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove4, 'function TArray_Remove(var arr: TCharArray; const item: Char; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove5, 'function TArray_Remove(var arr: TBooleanArray; const item: Boolean; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove6, 'function TArray_Remove(var arr: TPointArray; const item: TPoint; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove7, 'function TArray_Remove(var arr: TBoxArray; const item: TBox; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove8, 'function TArray_Remove(var arr: TRangeArray; const item: TRange; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove9, 'function TArray_Remove(var arr: TIntegerArray; const item: Integer; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove10, 'function TArray_Remove(var arr: TDoubleArray; const item: Double; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove11, 'function TArray_Remove(var arr: TStringArray; const item: string; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove12, 'function TArray_Remove(var arr: TCharArray; const item: Char; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove13, 'function TArray_Remove(var arr: TBooleanArray; const item: Boolean; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove14, 'function TArray_Remove(var arr: TPointArray; const item: TPoint; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove15, 'function TArray_Remove(var arr: TBoxArray; const item: TBox; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove16, 'function TArray_Remove(var arr: TRangeArray; const item: TRange; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove17, 'function TArray_Remove(var arr: TIntegerArray; const items: TIntegerArray; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove18, 'function TArray_Remove(var arr: TDoubleArray; const items: TDoubleArray; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove19, 'function TArray_Remove(var arr: TStringArray; const items: TStringArray; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove20, 'function TArray_Remove(var arr: TCharArray; const items: TCharArray; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove21, 'function TArray_Remove(var arr: TBooleanArray; const items: TBooleanArray; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove22, 'function TArray_Remove(var arr: TPointArray; const items: TPointArray; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove23, 'function TArray_Remove(var arr: TBoxArray; const items: TBoxArray; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove24, 'function TArray_Remove(var arr: TRangeArray; const items: TRangeArray; const index: Integer = 0; const all: Boolean = True): Integer; overload;');
  AddFunction(@TArray_Remove25, 'function TArray_Remove(var arr: TIntegerArray; const items: TIntegerArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove26, 'function TArray_Remove(var arr: TDoubleArray; const items: TDoubleArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove27, 'function TArray_Remove(var arr: TStringArray; const items: TStringArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove28, 'function TArray_Remove(var arr: TCharArray; const items: TCharArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove29, 'function TArray_Remove(var arr: TBooleanArray; const items: TBooleanArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove30, 'function TArray_Remove(var arr: TPointArray; const items: TPointArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove31, 'function TArray_Remove(var arr: TBoxArray; const items: TBoxArray; const all: Boolean): Integer; overload;');
  AddFunction(@TArray_Remove32, 'function TArray_Remove(var arr: TRangeArray; const items: TRangeArray; const all: Boolean): Integer; overload;');
  ...
  AddFunction(@TArray_Size1, 'function TArray_Size(var arr: TIntegerArray; const aize: Integer): Integer; overload;');
  AddFunction(@TArray_Size2, 'function TArray_Size(var arr: TDoubleArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Size3, 'function TArray_Size(var arr: TStringArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Size4, 'function TArray_Size(var arr: TCharArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Size5, 'function TArray_Size(var arr: TBooleanArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Size6, 'function TArray_Size(var arr: TPointArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Size7, 'function TArray_Size(var arr: TBoxArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Size8, 'function TArray_Size(var arr: TRangeArray; const aSize: Integer): Integer; overload;');
  AddFunction(@TArray_Size9, 'function TArray_Size(const arr: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Size10, 'function TArray_Size(const arr: TDoubleArray): Integer; overload;');
  AddFunction(@TArray_Size11, 'function TArray_Size(const arr: TStringArray): Integer; overload;');
  AddFunction(@TArray_Size12, 'function TArray_Size(const arr: TCharArray): Integer; overload;');
  AddFunction(@TArray_Size13, 'function TArray_Size(const arr: TBooleanArray): Integer; overload;');
  AddFunction(@TArray_Size14, 'function TArray_Size(const arr: TPointArray): Integer; overload;');
  AddFunction(@TArray_Size15, 'function TArray_Size(const arr: TBoxArray): Integer; overload;');
  AddFunction(@TArray_Size16, 'function TArray_Size(const arr: TRangeArray): Integer; overload;');
  ...
  AddFunction(@TArray_Swap3, 'function TArray_Swap(var arr, b: TStringArray): Integer; overload;');
  AddFunction(@TArray_Swap4, 'function TArray_Swap(var arr, b: TCharArray): Integer; overload;');
  AddFunction(@TArray_Swap5, 'function TArray_Swap(var arr, b: TBooleanArray): Integer; overload;');
  AddFunction(@TArray_Swap6, 'function TArray_Swap(var arr, b: TPointArray): Integer; overload;');
  AddFunction(@TArray_Swap7, 'function TArray_Swap(var arr, b: TBoxArray): Integer; overload;');
  AddFunction(@TArray_Swap8, 'function TArray_Swap(var arr, b: TRangeArray): Integer; overload;');
  ...
  AddFunction(@TArray_Unique1, 'function TArray_Unique(var arr: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Unique2, 'function TArray_Unique(var arr: TDoubleArray): Integer; overload;');
  AddFunction(@TArray_Unique3, 'function TArray_Unique(var arr: TStringArray): Integer; overload;');
  AddFunction(@TArray_Unique4, 'function TArray_Unique(var arr: TCharArray): Integer; overload;');
  AddFunction(@TArray_Unique5, 'function TArray_Unique(var arr: TBooleanArray): Integer; overload;');
  AddFunction(@TArray_Unique6, 'function TArray_Unique(var arr: TPointArray): Integer; overload;');
  AddFunction(@TArray_Unique7, 'function TArray_Unique(var arr: TBoxArray): Integer; overload;');
  AddFunction(@TArray_Unique8, 'function TArray_Unique(var arr: TRangeArray): Integer; overload;');
  ...
  AddFunction(@TArray_Unshift1, 'function TArray_Unshift(var arr: TIntegerArray; const item: Integer): Integer; overload;');
  AddFunction(@TArray_Unshift2, 'function TArray_Unshift(var arr: TDoubleArray; const item: Double): Integer; overload;');
  AddFunction(@TArray_Unshift3, 'function TArray_Unshift(var arr: TStringArray; const item: string): Integer; overload;');
  AddFunction(@TArray_Unshift4, 'function TArray_Unshift(var arr: TCharArray; const item: Char): Integer; overload;');
  AddFunction(@TArray_Unshift5, 'function TArray_Unshift(var arr: TBooleanArray; const item: Boolean): Integer; overload;');
  AddFunction(@TArray_Unshift6, 'function TArray_Unshift(var arr: TPointArray; const item: TPoint): Integer; overload;');
  AddFunction(@TArray_Unshift7, 'function TArray_Unshift(var arr: TBoxArray; const item: TBox): Integer; overload;');
  AddFunction(@TArray_Unshift8, 'function TArray_Unshift(var arr: TRangeArray; const item: TRange): Integer; overload;');
  AddFunction(@TArray_Unshift9, 'function TArray_Unshift(var arr: TIntegerArray; const items: TIntegerArray): Integer; overload;');
  AddFunction(@TArray_Unshift10, 'function TArray_Unshift(var arr: TDoubleArray; const items: TDoubleArray): Integer; overload;');
  AddFunction(@TArray_Unshift11, 'function TArray_Unshift(var arr: TStringArray; const items: TStringArray): Integer; overload;');
  AddFunction(@TArray_Unshift12, 'function TArray_Unshift(var arr: TCharArray; const items: TCharArray): Integer; overload;');
  AddFunction(@TArray_Unshift13, 'function TArray_Unshift(var arr: TBooleanArray; const items: TBooleanArray): Integer; overload;');
  AddFunction(@TArray_Unshift14, 'function TArray_Unshift(var arr: TPointArray; const items: TPointArray): Integer; overload;');
  AddFunction(@TArray_Unshift15, 'function TArray_Unshift(var arr: TBoxArray; const items: TBoxArray): Integer; overload;');
  AddFunction(@TArray_Unshift16, 'function TArray_Unshift(var arr: TRangeArray; const items: TRangeArray): Integer; overload;');
  ...
  AddFunction(@T2DArray_Create1, 'function T2DArray_Create(const size1D, size2D: Integer; const item: Integer): T2DIntegerArray; overload;');
  AddFunction(@T2DArray_Create2, 'function T2DArray_Create(const size1D, size2D: Integer; const item: Double): T2DDoubleArray; overload;');
  AddFunction(@T2DArray_Create3, 'function T2DArray_Create(const size1D, size2D: Integer; const item: string): T2DStringArray; overload;');
  AddFunction(@T2DArray_Create4, 'function T2DArray_Create(const size1D, size2D: Integer; const item: Char): T2DCharArray; overload;');
  AddFunction(@T2DArray_Create5, 'function T2DArray_Create(const size1D, size2D: Integer; const item: Boolean): T2DBooleanArray; overload;');
  AddFunction(@T2DArray_Create6, 'function T2DArray_Create(const size1D, size2D: Integer; const item: TPoint): T2DPointArray; overload;');
  AddFunction(@T2DArray_Create7, 'function T2DArray_Create(const size1D, size2D: Integer; const item: TBox): T2DBoxArray; overload;');
  AddFunction(@T2DArray_Create8, 'function T2DArray_Create(const size1D, size2D: Integer; const item: TRange): T2DRangeArray; overload;');
