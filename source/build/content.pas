...
begin
  ...
  AddFunction(@String_PosL, 'function String_PosL(const str, s: string; const index: Int32 = 1): Int32;');
  AddFunction(@String_PosR, 'function String_PosR(const str, s: string; const index: Int32 = 2147483647): Int32;');
  AddFunction(@String_Pos, 'function String_Pos(const str, s: string; const index: Int32 = 1): Int32;');
  AddFunction(@String_PosLast, 'function String_PosLast(const str, s: string; const index: Int32 = 2147483647): Int32;');
  AddFunction(@String_Position, 'function String_Position(const str, s: string; const index: Int32 = 1): Int32;');
  AddFunction(@String_Contains, 'function String_Contains(const str, s: string; const index: Int32 = 1): Boolean;');
  AddFunction(@String_Includes, 'function String_Includes(const str, s: string; const index: Int32 = 2147483647): Boolean;');
  AddFunction(@String_Between, 'function String_Between(const str, s1, s2: string; const index: Int32 = 1): string;');
  AddFunction(@String_Count, 'function String_Count(const str, s: string; const overlap: Boolean = True; const index: Int32 = 1): Int32;');
  AddFunction(@String_Amount, 'function String_Amount(const str, s: string; const overlap: Boolean = True; const index: Int32 = 2147483647): Int32;');
  AddFunction(@String_FromLeft, 'function String_FromLeft(const str: string; const count: Int32; const index: Int32 = 1): string;');
  AddFunction(@String_FromRight, 'function String_FromRight(const str: string; const count: Int32; const index: Int32 = 2147483647): string;');
  ...
  AddFunction(@String_Begin, 'function String_Begin(var str: string; const s: string; const index: Int32 = 1): Boolean;');
  AddFunction(@String_End, 'function String_End(var str: string; const s: string; const index: Int32 = 2147483647): Boolean;');
  AddFunction(@String_Behind, 'function String_Behind(const str: string; const index, count: Int32): string;');
  AddFunction(@String_Ahead, 'function String_Ahead(const str: string; const index, count: Int32): string;');
  AddFunction(@String_After, 'function String_After(const str, s: string; const index: Int32 = 1): string;');
  AddFunction(@String_Before, 'function String_Before(const str, s: string; const index: Int32 = 1): string;');
  AddFunction(@String_AfterLast, 'function String_AfterLast(const str, s: string; const index: Int32 = 2147483647): string;');
  AddFunction(@String_BeforeLast, 'function String_BeforeLast(const str, s: string; const index: Int32 = 2147483647): string;');
  ...
  AddFunction(@String_Duplicate, 'function String_Duplicate(const str: string; const x: Int32 = 2): string;');
  AddFunction(@String_Duplicated, 'function String_Duplicated(const str: string; const x: Int32; const glue: string): string;');
  ...
  AddFunction(@TIntegerArray_Unique, 'function TIntegerArray_Unique(var arr: TIntegerArray): Int32;');
  ...
  AddFunction(@TIntegerArray_BubbleSort2, 'function TIntegerArray_BubbleSort2(var arr: TIntegerArray; const ascending: Boolean = True): Int32;');
  ...
  AddFunction(@TIntegerArray_QuickSort3W, 'function TIntegerArray_QuickSort3W(var arr: TIntegerArray; const ascending: Boolean = True): Int32;');
  ...
  AddFunction(@TIntegerArray_GnomeSortOptimized, 'function TIntegerArray_GnomeSortOptimized(var arr: TIntegerArray; const ascending: Boolean = True): Int32;');
  ...
  AddFunction(@TIntegerArray_PancakeSort, 'function TIntegerArray_PancakeSort(var arr: TIntegerArray; const ascending: Boolean = True): Int32;');
  ...
  AddFunction(@TIntegerArray_SelectionSort, 'function TIntegerArray_SelectionSort(var arr: TIntegerArray; const ascending: Boolean = True): Int32;');
  AddFunction(@TIntegerArray_SelectionSortBidirectional, 'function TIntegerArray_SelectionSortBidirectional(var arr: TIntegerArray; const ascending: Boolean = True): Int32;');
  AddFunction(@TIntegerArray_SelectionSortBidirectional2, 'function TIntegerArray_SelectionSortBidirectional2(var arr: TIntegerArray; const ascending: Boolean = True): Int32;');
  ...
  AddFunction(@TArray_Clone_Int32, 'function TArray_Clone(const arr: TIntegerArray; const index: Int32 = 0; const count: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_Clone_Double, 'function TArray_Clone(const arr: TDoubleArray; const index: Int32 = 0; const count: Int32 = 2147483647): TDoubleArray; overload;');
  AddFunction(@TArray_Clone_String, 'function TArray_Clone(const arr: TStringArray; const index: Int32 = 0; const count: Int32 = 2147483647): TStringArray; overload;');
  AddFunction(@TArray_Clone_Char, 'function TArray_Clone(const arr: TCharArray; const index: Int32 = 0; const count: Int32 = 2147483647): TCharArray; overload;');
  AddFunction(@TArray_Clone_Boolean, 'function TArray_Clone(const arr: TBooleanArray; const index: Int32 = 0; const count: Int32 = 2147483647): TBooleanArray; overload;');
  AddFunction(@TArray_Clone_TPoint, 'function TArray_Clone(const arr: TPointArray; const index: Int32 = 0; const count: Int32 = 2147483647): TPointArray; overload;');
  AddFunction(@TArray_Clone_TBox, 'function TArray_Clone(const arr: TBoxArray; const index: Int32 = 0; const count: Int32 = 2147483647): TBoxArray; overload;');
  AddFunction(@TArray_Clone_TRange, 'function TArray_Clone(const arr: TRangeArray; const index: Int32 = 0; const count: Int32 = 2147483647): TRangeArray; overload;');
  ...
  AddFunction(@TArray_Contains_Int32, 'function TArray_Contains(const arr: TIntegerArray; const item: Int32; const index: Int32 = 0): Boolean; overload;');
  AddFunction(@TArray_Contains_Double, 'function TArray_Contains(const arr: TDoubleArray; const item: Double; const index: Int32 = 0): Boolean; overload;');
  AddFunction(@TArray_Contains_String, 'function TArray_Contains(const arr: TStringArray; const item: string; const index: Int32 = 0): Boolean; overload;');
  AddFunction(@TArray_Contains_Char, 'function TArray_Contains(const arr: TCharArray; const item: Char; const index: Int32 = 0): Boolean; overload;');
  AddFunction(@TArray_Contains_Boolean, 'function TArray_Contains(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 0): Boolean; overload;');
  AddFunction(@TArray_Contains_TPoint, 'function TArray_Contains(const arr: TPointArray; const item: TPoint; const index: Int32 = 0): Boolean; overload;');
  AddFunction(@TArray_Contains_TBox, 'function TArray_Contains(const arr: TBoxArray; const item: TBox; const index: Int32 = 0): Boolean; overload;');
  AddFunction(@TArray_Contains_TRange, 'function TArray_Contains(const arr: TRangeArray; const item: TRange; const index: Int32 = 0): Boolean; overload;');

  AddFunction(@TArray_Copy_Int32, 'function TArray_Copy(const arr: TIntegerArray; const index: Int32 = 0; const count: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_Copy_Double, 'function TArray_Copy(const arr: TDoubleArray; const index: Int32 = 0; const count: Int32 = 2147483647): TDoubleArray; overload;');
  AddFunction(@TArray_Copy_String, 'function TArray_Copy(const arr: TStringArray; const index: Int32 = 0; const count: Int32 = 2147483647): TStringArray; overload;');
  AddFunction(@TArray_Copy_Char, 'function TArray_Copy(const arr: TCharArray; const index: Int32 = 0; const count: Int32 = 2147483647): TCharArray; overload;');
  AddFunction(@TArray_Copy_Boolean, 'function TArray_Copy(const arr: TBooleanArray; const index: Int32 = 0; const count: Int32 = 2147483647): TBooleanArray; overload;');
  AddFunction(@TArray_Copy_TPoint, 'function TArray_Copy(const arr: TPointArray; const index: Int32 = 0; const count: Int32 = 2147483647): TPointArray; overload;');
  AddFunction(@TArray_Copy_TBox, 'function TArray_Copy(const arr: TBoxArray; const index: Int32 = 0; const count: Int32 = 2147483647): TBoxArray; overload;');
  AddFunction(@TArray_Copy_TRange, 'function TArray_Copy(const arr: TRangeArray; const index: Int32 = 0; const count: Int32 = 2147483647): TRangeArray; overload;');
  ...
  AddFunction(@TArray_Create_Int32, 'function TArray_Create(const item: Int32): TIntegerArray; overload;');
  ...
  AddFunction(@TArray_Create_Int32_1, 'function TArray_Create(const size: Int32; const item: Int32): TIntegerArray; overload;');
  AddFunction(@TArray_Create_Double_1, 'function TArray_Create(const size: Int32; const item: Double): TDoubleArray; overload;');
  AddFunction(@TArray_Create_String_1, 'function TArray_Create(const size: Int32; const item: string): TStringArray; overload;');
  AddFunction(@TArray_Create_Char_1, 'function TArray_Create(const size: Int32; const item: Char): TCharArray; overload;');
  AddFunction(@TArray_Create_Boolean_1, 'function TArray_Create(const size: Int32; const item: Boolean): TBooleanArray; overload;');
  AddFunction(@TArray_Create_TPoint_1, 'function TArray_Create(const size: Int32; const item: TPoint): TPointArray; overload;');
  AddFunction(@TArray_Create_TBox_1, 'function TArray_Create(const size: Int32; const item: TBox): TBoxArray; overload;');
  AddFunction(@TArray_Create_TRange_1, 'function TArray_Create(const size: Int32; const item: TRange): TRangeArray; overload;');
  ...
  AddFunction(@TArray_Extract_Int32, 'function TArray_Extract(const arr: TIntegerArray; const item: Int32; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Extract_Double, 'function TArray_Extract(const arr: TDoubleArray; const item: Double; const index: Int32 = 0): TDoubleArray; overload;');
  AddFunction(@TArray_Extract_String, 'function TArray_Extract(const arr: TStringArray; const item: string; const index: Int32 = 0): TStringArray; overload;');
  AddFunction(@TArray_Extract_Char, 'function TArray_Extract(const arr: TCharArray; const item: Char; const index: Int32 = 0): TCharArray; overload;');
  AddFunction(@TArray_Extract_Boolean, 'function TArray_Extract(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 0): TBooleanArray; overload;');
  AddFunction(@TArray_Extract_TPoint, 'function TArray_Extract(const arr: TPointArray; const item: TPoint; const index: Int32 = 0): TPointArray; overload;');
  AddFunction(@TArray_Extract_TBox, 'function TArray_Extract(const arr: TBoxArray; const item: TBox; const index: Int32 = 0): TBoxArray; overload;');
  AddFunction(@TArray_Extract_TRange, 'function TArray_Extract(const arr: TRangeArray; const item: TRange; const index: Int32 = 0): TRangeArray; overload;');
  AddFunction(@TArray_Extract_Int32_1, 'function TArray_Extract(const arr: TIntegerArray; const items: TIntegerArray; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Extract_Double_1, 'function TArray_Extract(const arr: TDoubleArray; const items: TDoubleArray; const index: Int32 = 0): TDoubleArray; overload;');
  AddFunction(@TArray_Extract_String_1, 'function TArray_Extract(const arr: TStringArray; const items: TStringArray; const index: Int32 = 0): TStringArray; overload;');
  AddFunction(@TArray_Extract_Char_1, 'function TArray_Extract(const arr: TCharArray; const items: TCharArray; const index: Int32 = 0): TCharArray; overload;');
  AddFunction(@TArray_Extract_Boolean_1, 'function TArray_Extract(const arr: TBooleanArray; const items: TBooleanArray; const index: Int32 = 0): TBooleanArray; overload;');
  AddFunction(@TArray_Extract_TPoint_1, 'function TArray_Extract(const arr: TPointArray; const items: TPointArray; const index: Int32 = 0): TPointArray; overload;');
  AddFunction(@TArray_Extract_TBox_1, 'function TArray_Extract(const arr: TBoxArray; const items: TBoxArray; const index: Int32 = 0): TBoxArray; overload;');
  AddFunction(@TArray_Extract_TRange_1, 'function TArray_Extract(const arr: TRangeArray; const items: TRangeArray; const index: Int32 = 0): TRangeArray; overload;');

  AddFunction(@TArray_ExtractEvery_Int32, 'function TArray_ExtractEvery(const arr: TIntegerArray; const X: Int32 = 1; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_ExtractEvery_Double, 'function TArray_ExtractEvery(const arr: TDoubleArray; const X: Int32 = 1; const index: Int32 = 0): TDoubleArray; overload;');
  AddFunction(@TArray_ExtractEvery_String, 'function TArray_ExtractEvery(const arr: TStringArray; const X: Int32 = 1; const index: Int32 = 0): TStringArray; overload;');
  AddFunction(@TArray_ExtractEvery_Char, 'function TArray_ExtractEvery(const arr: TCharArray; const X: Int32 = 1; const index: Int32 = 0): TCharArray; overload;');
  AddFunction(@TArray_ExtractEvery_Boolean, 'function TArray_ExtractEvery(const arr: TBooleanArray; const X: Int32 = 1; const index: Int32 = 0): TBooleanArray; overload;');
  AddFunction(@TArray_ExtractEvery_TPoint, 'function TArray_ExtractEvery(const arr: TPointArray; const X: Int32 = 1; const index: Int32 = 0): TPointArray; overload;');
  AddFunction(@TArray_ExtractEvery_TBox, 'function TArray_ExtractEvery(const arr: TBoxArray; const X: Int32 = 1; const index: Int32 = 0): TBoxArray; overload;');
  AddFunction(@TArray_ExtractEvery_TRange, 'function TArray_ExtractEvery(const arr: TRangeArray; const X: Int32 = 1; const index: Int32 = 0): TRangeArray; overload;');

  AddFunction(@TArray_Fill_Int32, 'function TArray_Fill(const arr: TIntegerArray; const item: Int32; const index: Int32 = 0; const count: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_Fill_Double, 'function TArray_Fill(const arr: TDoubleArray; const item: Double; const index: Int32 = 0; const count: Int32 = 2147483647): TDoubleArray; overload;');
  AddFunction(@TArray_Fill_String, 'function TArray_Fill(const arr: TStringArray; const item: string; const index: Int32 = 0; const count: Int32 = 2147483647): TStringArray; overload;');
  AddFunction(@TArray_Fill_Char, 'function TArray_Fill(const arr: TCharArray; const item: Char; const index: Int32 = 0; const count: Int32 = 2147483647): TCharArray; overload;');
  AddFunction(@TArray_Fill_Boolean, 'function TArray_Fill(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 0; const count: Int32 = 2147483647): TBooleanArray; overload;');
  AddFunction(@TArray_Fill_TPoint, 'function TArray_Fill(const arr: TPointArray; const item: TPoint; const index: Int32 = 0; const count: Int32 = 2147483647): TPointArray; overload;');
  AddFunction(@TArray_Fill_TBox, 'function TArray_Fill(const arr: TBoxArray; const item: TBox; const index: Int32 = 0; const count: Int32 = 2147483647): TBoxArray; overload;');
  AddFunction(@TArray_Fill_TRange, 'function TArray_Fill(const arr: TRangeArray; const item: TRange; const index: Int32 = 0; const count: Int32 = 2147483647): TRangeArray; overload;');
  AddFunction(@TArray_Fill_Int32_1, 'function TArray_Fill(const arr: TIntegerArray; const items: TIntegerArray; const index: Int32 = 0; const count: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_Fill_Double_1, 'function TArray_Fill(const arr: TDoubleArray; const items: TDoubleArray; const index: Int32 = 0; const count: Int32 = 2147483647): TDoubleArray; overload;');
  AddFunction(@TArray_Fill_String_1, 'function TArray_Fill(const arr: TStringArray; const items: TStringArray; const index: Int32 = 0; const count: Int32 = 2147483647): TStringArray; overload;');
  AddFunction(@TArray_Fill_Char_1, 'function TArray_Fill(const arr: TCharArray; const items: TCharArray; const index: Int32 = 0; const count: Int32 = 2147483647): TCharArray; overload;');
  AddFunction(@TArray_Fill_Boolean_1, 'function TArray_Fill(const arr: TBooleanArray; const items: TBooleanArray; const index: Int32 = 0; const count: Int32 = 2147483647): TBooleanArray; overload;');
  AddFunction(@TArray_Fill_TPoint_1, 'function TArray_Fill(const arr: TPointArray; const items: TPointArray; const index: Int32 = 0; const count: Int32 = 2147483647): TPointArray; overload;');
  AddFunction(@TArray_Fill_TBox_1, 'function TArray_Fill(const arr: TBoxArray; const items: TBoxArray; const index: Int32 = 0; const count: Int32 = 2147483647): TBoxArray; overload;');
  AddFunction(@TArray_Fill_TRange_1, 'function TArray_Fill(const arr: TRangeArray; const items: TRangeArray; const index: Int32 = 0; const count: Int32 = 2147483647): TRangeArray; overload;');

  AddFunction(@TArray_Filter_Int32, 'function TArray_Filter(const arr: TIntegerArray; const item: Int32; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Filter_Double, 'function TArray_Filter(const arr: TDoubleArray; const item: Double; const index: Int32 = 0): TDoubleArray; overload;');
  AddFunction(@TArray_Filter_String, 'function TArray_Filter(const arr: TStringArray; const item: string; const index: Int32 = 0): TStringArray; overload;');
  AddFunction(@TArray_Filter_Char, 'function TArray_Filter(const arr: TCharArray; const item: Char; const index: Int32 = 0): TCharArray; overload;');
  AddFunction(@TArray_Filter_Boolean, 'function TArray_Filter(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 0): TBooleanArray; overload;');
  AddFunction(@TArray_Filter_TPoint, 'function TArray_Filter(const arr: TPointArray; const item: TPoint; const index: Int32 = 0): TPointArray; overload;');
  AddFunction(@TArray_Filter_TBox, 'function TArray_Filter(const arr: TBoxArray; const item: TBox; const index: Int32 = 0): TBoxArray; overload;');
  AddFunction(@TArray_Filter_TRange, 'function TArray_Filter(const arr: TRangeArray; const item: TRange; const index: Int32 = 0): TRangeArray; overload;');
  AddFunction(@TArray_Filter_Int32_1, 'function TArray_Filter(const arr: TIntegerArray; const items: TIntegerArray; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Filter_Double_1, 'function TArray_Filter(const arr: TDoubleArray; const items: TDoubleArray; const index: Int32 = 0): TDoubleArray; overload;');
  AddFunction(@TArray_Filter_String_1, 'function TArray_Filter(const arr: TStringArray; const items: TStringArray; const index: Int32 = 0): TStringArray; overload;');
  AddFunction(@TArray_Filter_Char_1, 'function TArray_Filter(const arr: TCharArray; const items: TCharArray; const index: Int32 = 0): TCharArray; overload;');
  AddFunction(@TArray_Filter_Boolean_1, 'function TArray_Filter(const arr: TBooleanArray; const items: TBooleanArray; const index: Int32 = 0): TBooleanArray; overload;');
  AddFunction(@TArray_Filter_TPoint_1, 'function TArray_Filter(const arr: TPointArray; const items: TPointArray; const index: Int32 = 0): TPointArray; overload;');
  AddFunction(@TArray_Filter_TBox_1, 'function TArray_Filter(const arr: TBoxArray; const items: TBoxArray; const index: Int32 = 0): TBoxArray; overload;');
  AddFunction(@TArray_Filter_TRange_1, 'function TArray_Filter(const arr: TRangeArray; const items: TRangeArray; const index: Int32 = 0): TRangeArray; overload;');

  AddFunction(@TArray_FilterEvery_Int32, 'function TArray_FilterEvery(const arr: TIntegerArray; const X: Int32 = 1; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_FilterEvery_Double, 'function TArray_FilterEvery(const arr: TDoubleArray; const X: Int32 = 1; const index: Int32 = 0): TDoubleArray; overload;');
  AddFunction(@TArray_FilterEvery_String, 'function TArray_FilterEvery(const arr: TStringArray; const X: Int32 = 1; const index: Int32 = 0): TStringArray; overload;');
  AddFunction(@TArray_FilterEvery_Char, 'function TArray_FilterEvery(const arr: TCharArray; const X: Int32 = 1; const index: Int32 = 0): TCharArray; overload;');
  AddFunction(@TArray_FilterEvery_Boolean, 'function TArray_FilterEvery(const arr: TBooleanArray; const X: Int32 = 1; const index: Int32 = 0): TBooleanArray; overload;');
  AddFunction(@TArray_FilterEvery_TPoint, 'function TArray_FilterEvery(const arr: TPointArray; const X: Int32 = 1; const index: Int32 = 0): TPointArray; overload;');
  AddFunction(@TArray_FilterEvery_TBox, 'function TArray_FilterEvery(const arr: TBoxArray; const X: Int32 = 1; const index: Int32 = 0): TBoxArray; overload;');
  AddFunction(@TArray_FilterEvery_TRange, 'function TArray_FilterEvery(const arr: TRangeArray; const X: Int32 = 1; const index: Int32 = 0): TRangeArray; overload;');
  ...
  AddFunction(@TArray_Includes_Int32, 'function TArray_Includes(const arr: TIntegerArray; const item: Int32; const index: Int32 = 2147483647): Boolean; overload;');
  AddFunction(@TArray_Includes_Double, 'function TArray_Includes(const arr: TDoubleArray; const item: Double; const index: Int32 = 2147483647): Boolean; overload;');
  AddFunction(@TArray_Includes_String, 'function TArray_Includes(const arr: TStringArray; const item: string; const index: Int32 = 2147483647): Boolean; overload;');
  AddFunction(@TArray_Includes_Char, 'function TArray_Includes(const arr: TCharArray; const item: Char; const index: Int32 = 2147483647): Boolean; overload;');
  AddFunction(@TArray_Includes_Boolean, 'function TArray_Includes(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 2147483647): Boolean; overload;');
  AddFunction(@TArray_Includes_TPoint, 'function TArray_Includes(const arr: TPointArray; const item: TPoint; const index: Int32 = 2147483647): Boolean; overload;');
  AddFunction(@TArray_Includes_TBox, 'function TArray_Includes(const arr: TBoxArray; const item: TBox; const index: Int32 = 2147483647): Boolean; overload;');
  AddFunction(@TArray_Includes_TRange, 'function TArray_Includes(const arr: TRangeArray; const item: TRange; const index: Int32 = 2147483647): Boolean; overload;');
  ...
  AddFunction(@TArray_Pos_Int32, 'function TArray_Pos(const arr: TIntegerArray; const item: Int32; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_Double, 'function TArray_Pos(const arr: TDoubleArray; const item: Double; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_String, 'function TArray_Pos(const arr: TStringArray; const item: string; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_Char, 'function TArray_Pos(const arr: TCharArray; const item: Char; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_Boolean, 'function TArray_Pos(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_TPoint, 'function TArray_Pos(const arr: TPointArray; const item: TPoint; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_TBox, 'function TArray_Pos(const arr: TBoxArray; const item: TBox; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_TRange, 'function TArray_Pos(const arr: TRangeArray; const item: TRange; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_Int32_1, 'function TArray_Pos(const arr: TIntegerArray; const items: TIntegerArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_Double_1, 'function TArray_Pos(const arr: TDoubleArray; const items: TDoubleArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_String_1, 'function TArray_Pos(const arr: TStringArray; const items: TStringArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_Char_1, 'function TArray_Pos(const arr: TCharArray; const items: TCharArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_Boolean_1, 'function TArray_Pos(const arr: TBooleanArray; const items: TBooleanArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_TPoint_1, 'function TArray_Pos(const arr: TPointArray; const items: TPointArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_TBox_1, 'function TArray_Pos(const arr: TBoxArray; const items: TBoxArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Pos_TRange_1, 'function TArray_Pos(const arr: TRangeArray; const items: TRangeArray; const index: Int32 = 0): Int32; overload;');

  AddFunction(@TArray_Position_Int32, 'function TArray_Position(const arr: TIntegerArray; const item: Int32; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_Double, 'function TArray_Position(const arr: TDoubleArray; const item: Double; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_String, 'function TArray_Position(const arr: TStringArray; const item: string; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_Char, 'function TArray_Position(const arr: TCharArray; const item: Char; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_Boolean, 'function TArray_Position(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_TPoint, 'function TArray_Position(const arr: TPointArray; const item: TPoint; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_TBox, 'function TArray_Position(const arr: TBoxArray; const item: TBox; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_TRange, 'function TArray_Position(const arr: TRangeArray; const item: TRange; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_Int32_1, 'function TArray_Position(const arr: TIntegerArray; const items: TIntegerArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_Double_1, 'function TArray_Position(const arr: TDoubleArray; const items: TDoubleArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_String_1, 'function TArray_Position(const arr: TStringArray; const items: TStringArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_Char_1, 'function TArray_Position(const arr: TCharArray; const items: TCharArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_Boolean_1, 'function TArray_Position(const arr: TBooleanArray; const items: TBooleanArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_TPoint_1, 'function TArray_Position(const arr: TPointArray; const items: TPointArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_TBox_1, 'function TArray_Position(const arr: TBoxArray; const items: TBoxArray; const index: Int32 = 0): Int32; overload;');
  AddFunction(@TArray_Position_TRange_1, 'function TArray_Position(const arr: TRangeArray; const items: TRangeArray; const index: Int32 = 0): Int32; overload;');

  AddFunction(@TArray_Positions_Int32, 'function TArray_Positions(const arr: TIntegerArray; const item: Int32; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_Double, 'function TArray_Positions(const arr: TDoubleArray; const item: Double; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_String, 'function TArray_Positions(const arr: TStringArray; const item: string; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_Char, 'function TArray_Positions(const arr: TCharArray; const item: Char; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_Boolean, 'function TArray_Positions(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_TPoint, 'function TArray_Positions(const arr: TPointArray; const item: TPoint; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_TBox, 'function TArray_Positions(const arr: TBoxArray; const item: TBox; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_TRange, 'function TArray_Positions(const arr: TRangeArray; const item: TRange; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_Int32_1, 'function TArray_Positions(const arr: TIntegerArray; const items: TIntegerArray; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_Double_1, 'function TArray_Positions(const arr: TDoubleArray; const items: TDoubleArray; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_String_1, 'function TArray_Positions(const arr: TStringArray; const items: TStringArray; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_Char_1, 'function TArray_Positions(const arr: TCharArray; const items: TCharArray; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_Boolean_1, 'function TArray_Positions(const arr: TBooleanArray; const items: TBooleanArray; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_TPoint_1, 'function TArray_Positions(const arr: TPointArray; const items: TPointArray; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_TBox_1, 'function TArray_Positions(const arr: TBoxArray; const items: TBoxArray; const index: Int32 = 0): TIntegerArray; overload;');
  AddFunction(@TArray_Positions_TRange_1, 'function TArray_Positions(const arr: TRangeArray; const items: TRangeArray; const index: Int32 = 0): TIntegerArray; overload;');

  AddFunction(@TArray_PosLast_Int32, 'function TArray_PosLast(const arr: TIntegerArray; const item: Int32; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_Double, 'function TArray_PosLast(const arr: TDoubleArray; const item: Double; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_String, 'function TArray_PosLast(const arr: TStringArray; const item: string; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_Char, 'function TArray_PosLast(const arr: TCharArray; const item: Char; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_Boolean, 'function TArray_PosLast(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_TPoint, 'function TArray_PosLast(const arr: TPointArray; const item: TPoint; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_TBox, 'function TArray_PosLast(const arr: TBoxArray; const item: TBox; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_TRange, 'function TArray_PosLast(const arr: TRangeArray; const item: TRange; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_Int32_1, 'function TArray_PosLast(const arr: TIntegerArray; const items: TIntegerArray; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_Double_1, 'function TArray_PosLast(const arr: TDoubleArray; const items: TDoubleArray; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_String_1, 'function TArray_PosLast(const arr: TStringArray; const items: TStringArray; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_Char_1, 'function TArray_PosLast(const arr: TCharArray; const items: TCharArray; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_Boolean_1, 'function TArray_PosLast(const arr: TBooleanArray; const items: TBooleanArray; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_TPoint_1, 'function TArray_PosLast(const arr: TPointArray; const items: TPointArray; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_TBox_1, 'function TArray_PosLast(const arr: TBoxArray; const items: TBoxArray; const index: Int32 = 2147483647): Int32; overload;');
  AddFunction(@TArray_PosLast_TRange_1, 'function TArray_PosLast(const arr: TRangeArray; const items: TRangeArray; const index: Int32 = 2147483647): Int32; overload;');

  AddFunction(@TArray_PosLasts_Int32, 'function TArray_PosLasts(const arr: TIntegerArray; const item: Int32; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_Double, 'function TArray_PosLasts(const arr: TDoubleArray; const item: Double; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_String, 'function TArray_PosLasts(const arr: TStringArray; const item: string; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_Char, 'function TArray_PosLasts(const arr: TCharArray; const item: Char; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_Boolean, 'function TArray_PosLasts(const arr: TBooleanArray; const item: Boolean; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_TPoint, 'function TArray_PosLasts(const arr: TPointArray; const item: TPoint; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_TBox, 'function TArray_PosLasts(const arr: TBoxArray; const item: TBox; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_TRange, 'function TArray_PosLasts(const arr: TRangeArray; const item: TRange; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_Int32_1, 'function TArray_PosLasts(const arr: TIntegerArray; const items: TIntegerArray; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_Double_1, 'function TArray_PosLasts(const arr: TDoubleArray; const items: TDoubleArray; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_String_1, 'function TArray_PosLasts(const arr: TStringArray; const items: TStringArray; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_Char_1, 'function TArray_PosLasts(const arr: TCharArray; const items: TCharArray; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_Boolean_1, 'function TArray_PosLasts(const arr: TBooleanArray; const items: TBooleanArray; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_TPoint_1, 'function TArray_PosLasts(const arr: TPointArray; const items: TPointArray; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_TBox_1, 'function TArray_PosLasts(const arr: TBoxArray; const items: TBoxArray; const index: Int32 = 2147483647): TIntegerArray; overload;');
  AddFunction(@TArray_PosLasts_TRange_1, 'function TArray_PosLasts(const arr: TRangeArray; const items: TRangeArray; const index: Int32 = 2147483647): TIntegerArray; overload;');
  ...
  AddFunction(@TArray_Remove_Int32, 'function TArray_Remove(var arr: TIntegerArray; const item: Int32; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_Double, 'function TArray_Remove(var arr: TDoubleArray; const item: Double; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_String, 'function TArray_Remove(var arr: TStringArray; const item: string; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_Char, 'function TArray_Remove(var arr: TCharArray; const item: Char; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_Boolean, 'function TArray_Remove(var arr: TBooleanArray; const item: Boolean; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_TPoint, 'function TArray_Remove(var arr: TPointArray; const item: TPoint; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_TBox, 'function TArray_Remove(var arr: TBoxArray; const item: TBox; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_TRange, 'function TArray_Remove(var arr: TRangeArray; const item: TRange; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  ...
  AddFunction(@TArray_Remove_Int32_2, 'function TArray_Remove(var arr: TIntegerArray; const items: TIntegerArray; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_Double_2, 'function TArray_Remove(var arr: TDoubleArray; const items: TDoubleArray; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_String_2, 'function TArray_Remove(var arr: TStringArray; const items: TStringArray; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_Char_2, 'function TArray_Remove(var arr: TCharArray; const items: TCharArray; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_Boolean_2, 'function TArray_Remove(var arr: TBooleanArray; const items: TBooleanArray; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_TPoint_2, 'function TArray_Remove(var arr: TPointArray; const items: TPointArray; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_TBox_2, 'function TArray_Remove(var arr: TBoxArray; const items: TBoxArray; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  AddFunction(@TArray_Remove_TRange_2, 'function TArray_Remove(var arr: TRangeArray; const items: TRangeArray; const index: Int32 = 0; const all: Boolean = True): Int32; overload;');
  ...
  AddFunction(@TArray_Set_Int32_2, 'function TArray_Set(const arr: TIntegerArray; const index: Int32; const items: TIntegerArray): TIntegerArray; overload;');
  AddFunction(@TArray_Set_Double_2, 'function TArray_Set(const arr: TDoubleArray; const index: Int32; const items: TDoubleArray): TDoubleArray; overload;');
  AddFunction(@TArray_Set_String_2, 'function TArray_Set(const arr: TStringArray; const index: Int32; const items: TStringArray): TStringArray; overload;');
  AddFunction(@TArray_Set_Char_2, 'function TArray_Set(const arr: TCharArray; const index: Int32; const items: TCharArray): TCharArray; overload;');
  AddFunction(@TArray_Set_Boolean_2, 'function TArray_Set(const arr: TBooleanArray; const index: Int32; const items: TBooleanArray): TBooleanArray; overload;');
  AddFunction(@TArray_Set_TPoint_2, 'function TArray_Set(const arr: TPointArray; const index: Int32; const items: TPointArray): TPointArray; overload;');
  AddFunction(@TArray_Set_TBox_2, 'function TArray_Set(const arr: TBoxArray; const index: Int32; const items: TBoxArray): TBoxArray; overload;');
  AddFunction(@TArray_Set_TRange_2, 'function TArray_Set(const arr: TRangeArray; const index: Int32; const items: TRangeArray): TRangeArray; overload;');
