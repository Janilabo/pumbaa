...
begin
  ...
  AddFunction(@String_Pick, 'function String_Pick(const str: string; const index: Int32; const size: Int32 = 2147483647): string;');
  AddFunction(@String_PosL, 'function String_PosL(const str, s: string; const start: Int32 = 1): Int32;');
  AddFunction(@String_PosR, 'function String_PosR(const str, s: string; const start: Int32 = 2147483647): Int32;');
  AddFunction(@String_Pos, 'function String_Pos(const str, s: string; const start: Int32 = 1): Int32;');
  AddFunction(@String_PosLast, 'function String_PosLast(const str, s: string; const start: Int32 = 2147483647): Int32;');
  AddFunction(@String_Position, 'function String_Position(const str, s: string; const start: Int32 = 1): Int32;');
  AddFunction(@String_Contains, 'function String_Contains(const str, s: string; const start: Int32 = 1): Boolean;');
  AddFunction(@String_Includes, 'function String_Includes(const str, s: string; const start: Int32 = 2147483647): Boolean;');
  AddFunction(@String_Between, 'function String_Between(const str, s1, s2: string; const start: Int32 = 1): string;');
  AddFunction(@String_Count, 'function String_Count(const str, s: string; const overlap: Boolean = True; const start: Int32 = 1): Int32;');
  AddFunction(@String_Amount, 'function String_Amount(const str, s: string; const overlap: Boolean = True; const start: Int32 = 2147483647): Int32;');
  ...
  AddFunction(@String_Begin, 'function String_Begin(var str: string; const s: string; const start: Int32 = 1): Boolean;');
  AddFunction(@String_End, 'function String_End(var str: string; const s: string; const start: Int32 = 2147483647): Boolean;');
  ...
  AddFunction(@String_After, 'function String_After(const str, s: string; start: Int32 = 1): string;');
  AddFunction(@String_Before, 'function String_Before(const str, s: string; start: Int32 = 1): string;');
  AddFunction(@String_AfterLast, 'function String_AfterLast(const str, s: string; const start: Int32 = 2147483647): string;');
  AddFunction(@String_BeforeLast, 'function String_BeforeLast(const str, s: string; const start: Int32 = 2147483647): string;');
